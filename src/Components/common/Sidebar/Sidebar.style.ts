...
import TradeDashLogo from "Assets/Images/tradeDashLogoBg.png";
import { RTLType } from "Helpers/TypeConstants";
import { borderRadius, transition } from "Styles/StyleUtils";

export const SidebarWrapper = styled.div<RTLType>`
  .isomorphicSidebar {
    z-index: 1000;
    ...
    .site-icon {
      background-image: url(${TradeDashLogo});
